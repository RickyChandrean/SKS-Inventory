...
<head>
  ...
  <title>SKS-Inventory</title>
  <link rel="shortcut icon" type="image/png" href="../assets/images/logos/inv.png" />
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between mt-3">
          <a href="./index.php" class="text-nowrap logo-img">
            <img src="../assets/images/logos/inv.png" width="50" alt="" />
          </a>
          <span class="menu ml-3"> SKS-Inventory Management System</span>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="#" aria-expanded="false">
                ...
                <span class="hide-menu">Sales Data</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="#" aria-expanded="false">
            ...
            <li class="sidebar-item">
             ...
             <li class="sidebar-item">
              <a class="sidebar-link" href="#" aria-expanded="false">
                ...
                <span class="hide-menu">Item Stock</span>
              </a>
            </li>
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
